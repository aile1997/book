  ...
  <Teleport to="body">
    <Transition name="modal">
      <div
        ...
        style="background: linear-gradient(180deg, rgba(0, 0, 0, 0.62) 0%, rgba(102, 102, 102, 0.62) 100%); backdrop-filter: blur(12.5px)"
        @click.self="close"
      >
        <!-- 座位选择卡片 -->
            ...
            <div class="flex gap-3">
              ...
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M11.7322 14.4564C10.5895 14.794 9.239 14.9498 7.6547 14.9498H-0.136667C-1.72104 14.9498 -3.07146 14.794 -4.21417 14.4564C-3.92846 11.0801 -0.461458 8.41797 3.759 8.41797C7.97946 8.41797 11.4465 11.0801 11.7322 14.4564Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" transform="translate(8, 4)"/>
                  <path d="M8.4079 0.120117C8.4079 2.69137 6.33023 4.78195 3.759 4.78195C1.18775 4.78195 -0.889917 2.69137 -0.889917 0.120117C-0.889917 -2.45112 1.18775 -4.54879 3.759 -4.54879C6.33023 -4.54879 8.4079 -2.45112 8.4079 0.120117Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" transform="translate(8, 8)"/>
                  <circle cx="19" cy="9" r="2.5" stroke="white" stroke-width="1.5"/>
                  <line x1="17" y1="11" x2="14" y2="14" stroke="white" stroke-width="1.5" stroke-linecap="round"/>
                </svg>
              </button>
